...
SECRET_KEY = 'django-insecure-v%lfgf%$%^7164zwsagcgi&g$l73)o-f37q)^5n==z&xo1*g*x'
...
MEDIA_URL = '/media/'
MEDIA_ROOT = BASE_DIR / 'media'  # Directory for user-uploaded media files
